...
describe('The ExtraPositionService', function () {
    before(function(done) {
        let promises = [];
        promises.push(ExtraPosition.create({ deputyId: 2, position: 'Secrétaire' }))
        promises.push(ExtraPosition.create({ deputyId: 3, position: 'Membre' }))
        promises.push(ExtraPosition.create({ deputyId: 4, position: 'Président' }))
        promises.push(ExtraPosition.create({ deputyId: 41, position: 'Présidente' }))
        promises.push(ExtraPosition.create({ deputyId: 5, position: 'Questeur' }))
        promises.push(ExtraPosition.create({ deputyId: 51, position: 'Questeur' }))
        promises.push(ExtraPosition.create({ deputyId: 6, position: 'Vice-président' }))
        promises.push(ExtraPosition.create({ deputyId: 61, position: 'Vice-présidente' }))
        promises.push(ExtraPosition.create({ deputyId: 7, position: 'Président' }))
        promises.push(ExtraPosition.create({ deputyId: 71, position: 'Présidente' }))
        promises.push(ExtraPosition.create({ deputyId: 8, position: 'Rapporteur général' }))
        promises.push(ExtraPosition.create({ deputyId: 81, position: 'Rapporteure générale' }))
        promises.push(ExtraPosition.create({ deputyId: 82, position: 'Rapporteur général' }))
        promises.push(ExtraPosition.create({ deputyId: 9, position: 'Président' }))
        promises.push(ExtraPosition.create({ deputyId: 91, position: 'Président' }))
